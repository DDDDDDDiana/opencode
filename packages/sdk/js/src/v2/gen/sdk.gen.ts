...
export class Session extends HeyApiClient {
     ...
     *
     * Subscribe to real-time events for a specific session using server-sent events.
     */
    public event<ThrowOnError extends boolean = false>(parameters: {
        ...
        const params = buildClientParams([parameters], [{ args: [{ in: 'path', key: 'sessionID' }, { in: 'query', key: 'directory' }] }]);
        return (options?.client ?? this.client).sse.get<SessionEventResponses, SessionEventErrors, ThrowOnError>({
